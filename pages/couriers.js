...
<>
  ...
  <div className="bg-white dark:bg-gray-800 rounded-xl banner-pattern p-6 mb-3">
    <div className="flex justify-between items-center flex-wrap">
      <div>
        <h1 className="text-2xl font-bold text-black dark:text-white">Couriers</h1>
        <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Your all imported or generated couriers here</p>
      </div>
      <div className='flex gap-2 mt-2 md:mt-0'>
        ...
        <button
          ...
          <Link href=""
            ...
            <span className="text-sm ml-2 hidden md:block">Add Courier</span> 
  ...
  <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-3 ">
    <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-4 ">
      <p className="text-sm text-gray-500 dark:text-gray-400 mb-1">Total Couriers</p>
          ...
          <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
            ...
            <tbody className="dark:bg-gray-800 dark:divide-gray-700 bg-white divide-y divide-gray-200">
              ...
              <tr key={index} className="hover:bg-gray-50 dark:hover:bg-gray-800 ">
                ...
                <td className="px-6 py-4 whitespace-nowrap">{item.couriers}</td>
