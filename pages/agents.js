...
<>
  ...
  <div className="bg-white dark:bg-gray-800 rounded-xl banner-pattern p-6 mb-3">
    <div className="flex justify-between items-center flex-wrap">
      <div>
        <h1 className="text-2xl font-bold text-black dark:text-white">Agents</h1>
        <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Your all imported or generated agents here</p>
      </div>
      <div className='flex gap-2 mt-2 md:mt-0'>
        <div className="transform transition-all duration-300 ease-in-out origin-top" 
          ...
          <button
            ...
            <span className="relative z-10 group-hover:text-white flex items-center"> <i className="fa-solid fa-trash"></i>
          ...
          <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
            ...
            <tbody className="dark:bg-gray-800 dark:divide-gray-700 bg-white divide-y divide-gray-200">
              ...
              <tr key={index}  className="hover:bg-gray-50 dark:hover:bg-gray-800 ">
                ...
                <td className="px-6 py-4 whitespace-nowrap" onClick={() => window.location.href = '/agent_view'}>
                ...
                <td className="px-6 py-4 whitespace-nowrap text-sm" onClick={() => window.location.href = '/agent_view'}>{item.phone}</td>
                <td className="px-6 py-4 whitespace-nowrap text-sm" onClick={() => window.location.href = '/agent_view'}>{item.date}</td>
                <td className="px-6 py-4 whitespace-nowrap" onClick={() => window.location.href = '/agent_view'}>{item.leads}</td>
                <td className="px-6 py-4 whitespace-nowrap text-sm" onClick={() => window.location.href = '/agent_view'}>{item.score}</td>
                <td className="px-6 py-4 whitespace-nowrap text-sm" onClick={() => window.location.href = '/agent_view'}>{item.manager}</td>
                <td className="px-6 py-4 whitespace-nowrap text-sm" onClick={() => window.location.href = '/agent_view'}>
